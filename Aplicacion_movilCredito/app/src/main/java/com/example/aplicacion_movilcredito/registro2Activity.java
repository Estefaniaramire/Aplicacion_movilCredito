...
public class registro2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro2_);
        ...
        Button btnMenu = findViewById(R.id.btnRegister);
        ...
        btnMenu.setOnClickListener(v -> {
            Intent intent = new Intent(registro2Activity.this, MenuActivity.class);  // Cambia MenuActivity a la actividad de tu menú
        ...
        btnAceptar.setOnClickListener(v -> {
            ...
            if (edtComprobanteDomicilio.getText().toString().isEmpty() || edtINE.getText().toString().isEmpty()) {
                ...
                new AlertDialog.Builder(registro2Activity.this)
                        .setTitle("Error")
                ...
                new AlertDialog.Builder(registro2Activity.this)
                        .setTitle("Documentos correctos")
                        .setMessage("La documentación a sido procesada de manera correcta.")
